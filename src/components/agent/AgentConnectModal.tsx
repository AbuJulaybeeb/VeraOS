...
export const AgentConnectModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Card */}
      <div className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl bg-[#1D110B] border border-[#4A2B1D] shadow-[0_20px_60px_rgba(0,0,0,0.8)] p-4 sm:p-6 flex flex-col gap-4 z-10 animate-in fade-in zoom-in-95 duration-200">
        {/* Top Header */}
